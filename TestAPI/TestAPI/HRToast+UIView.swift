...
extension UIView {
    ...
    */
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = UIColor.clearColor().colorWithAlphaComponent(HRToastOpacity)
    ...
    */
    ...
    func viewForMessage(msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        wrapperView.backgroundColor = UIColor.clearColor().colorWithAlphaComponent(HRToastOpacity)
